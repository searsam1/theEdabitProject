from sort_by_answer import sort_by_answer
import unittest

class Test(unittest.TestCase):
	
	i=0
	def assert_equals(a,b,message=None,i=i):
		i += 1
		if a != b and message:
			print(message)
		elif a == b:
			...
			print("Test Failed")
			print(a,"Should Equal -->")
			print(b)
			print("\n\n")

		
Test.assert_equals(sort_by_answer(["1 + 1", "1 + 7", "1 + 5", "1 + 4"]), ["1 + 1", "1 + 4", "1 + 5", "1 + 7"])
...
Test.assert_equals(sort_by_answer(["-50 / 1", "3 / 32", "-46 + -37", "4 / -4", "-44 - 50", "12 / -19", "-11 / 37", "-7 + 37", "-15 / -10", "-31 + 8"]), ["-44 - 50", "-46 + -37", "-50 / 1", "-31 + 8", "4 / -4", "12 / -19", "-11 / 37", "3 / 32", "-15 / -10", "-7 + 37"])
